<?xml version="1.0" encoding="UTF-8"?><Root>
  <DeploymentSet allowEmptyValues="false" assetCompositeName="APIGatewayAssets" deploymentSetName="lpdpBRI_private_staging_deploymentset" serverAliasName="repo_lpdpBRI_private_staging" targetServerName="dev_server" targetServerType="APIGateway">
    ...
    <Component name="Alias.56ae7631-c4e2-4cdb-a047-8494314b851e" type="Alias">
      <Property propertyName="Endpoint URI for Endpoint alias api-close-gateway-url" propertyValue="http://api.close.staging.bri.co.id:5557"/>
